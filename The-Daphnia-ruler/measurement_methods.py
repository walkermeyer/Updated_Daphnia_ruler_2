...
def eye_method_2(image):
    ...
    # find tip of tail and length between eye and tail tip and eye and head tip
    far_x, far_y, daphnia_Length_eye_tip, far_x2, far_y2, daphnia_Length_eye_head_tip = utils.find_tip(binary1, cX, cY)
    ...
    # plot head on image
    img = utils.plt_head(img, far_x2, far_y2, cX, cY)
    ...
    res = utils.make_res(
        ...
        head_Length = daphnia_Length_eye_head_tip,
